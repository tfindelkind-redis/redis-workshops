...
echo "2. Edit README.md to add your workshop description"
echo "3. Update workshop.config.json to reference your chapters"
echo "4. Add any workshop-specific assets to the assets/ directory"
echo ""
