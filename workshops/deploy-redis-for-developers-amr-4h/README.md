...
duration: 060 minutes60 minutes50 minutes40
...
modules:
  ...
  - order: 3
    ...
    required: true
  - order: 4
    moduleRef: workshops/deploy-redis-for-developers-amr-4h/module-custom-provision--connect-lab
    required: true
---

# Deploy Redis for Developers - Azure Managed Redis 4h

**Duration:** 060 minutes60 minutes50 minutes40 | **Difficulty:** intermediate
...
**Total Duration:** 3h 30m | **Modules:** 4
...
| 3 | [Performance Efficiency & Data Modeling](module-03-performance-efficiency-data-modeling/README.md) | 50 minutesm | intermediate | hands-on | ✅ Yes |
| 4 | [Provision & Connect Lab (Custom)](module-04-provision-connect-lab-custom-/README.md) | 40m | intermediate | hands-on | ✅ Yes |
...
**Duration:** 50 minutes minutes | **Difficulty:** intermediate | **Type:** hands-on
...
### Module 4: Provision & Connect Lab (Custom)

📂 **[Go to Module](module-04-provision-connect-lab-custom-/README.md)**
...
### [Module 4: Provision & Connect Lab (Custom)](module-04-provision--connect-lab-custom/README.md)
